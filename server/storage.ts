  ...
  private addSampleData() {
    ...
    const sampleSuppliers = [
      ...
      },
      {
        ...
        cnpj: "22.272.444/0001-30",
        responsavel: "JOSÉ",
        email: "contato@postoassistencia.com",
        phone: "(92) 91234-5678",
    ...
    const sampleVehicles = [
      ...
      { id: 2, plate: "QZQ-1895", model: "HONDA CG 160 CARGO", brand: "Honda", year: 2021, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 3, plate: "QZQ-1875", model: "HONDA CG 160 CARGO", brand: "Honda", year: 2021, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 4, plate: "TAC-5179", model: "HONDA/CG 160 CARGO", brand: "Honda", year: 2020, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 5, plate: "QZN-9C01", model: "HYUNDAI HB20S", brand: "Hyundai", year: 2018, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      ...
      { id: 8, plate: "QAK-2560", model: "HYUNDAI HR HD", brand: "Hyundai", year: 2017, fuelType: "diesel", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      ...
      { id: 10, plate: "TAC-7187", model: "HYUNDAI/HR HBD 4WD", brand: "Hyundai", year: 2020, fuelType: "diesel", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 11, plate: "TSC5144", model: "JEEP", brand: "Jeep", year: 2015, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 12, plate: "QX2T14", model: "JEEP COMMANDER", brand: "Jeep", year: 2016, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      ...
      { id: 16, plate: "TAE-3155", model: "POLO", brand: "Volkswagen", year: 2019, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      ...
      { id: 18, plate: "QZT2D80", model: "SAVEIRO", brand: "Volkswagen", year: 2020, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      { id: 19, plate: "STZ3H82", model: "T-CROSS", brand: "Volkswagen", year: 2021, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
      ...
      { id: 30, plate: "QZV-8359", model: "CHEVROLET MONTANA", brand: "Chevrolet", year: 2018, fuelType: "gasolina", mileage: "0", status: "active", createdAt: yesterday.toISOString(), updatedAt: yesterday.toISOString() },
